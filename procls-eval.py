...
def parse_arguments():
    ...
    parser.add_argument(
        "--output_path",
        type=str,
        default='/home/tian.855/fungi/result/1.2lora32-ProClass.csv',
...
if __name__ == "__main__":
    ...
    bioclip.model.eval()
    bioclip.modify_lora_mergeFactor(merge_factor=1.2)
    ...
    # Create a new column with top-5 predictions for each image
    test_dataset.df["top5_preds"] = [" ".join(map(str, pred_list)) for pred_list in cls]
