...
def load_checkpoint(
    ...
    incompatible_keys = model.load_state_dict(state_dict, strict=False) ## To False
...
def create_model(
    ...
    if custom:
        model_cfg["vision_cfg"]['custom_model'] = True
        model_cfg["text_cfg"]['custom_model'] = True
    
    if LoRA_dim > 0:
        model_cfg["vision_cfg"]['LoRA_dim'] = LoRA_dim
        model_cfg["text_cfg"]['LoRA_dim'] = LoRA_dim
