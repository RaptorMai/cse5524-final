...
class CLIPVisionCfg:
    ...
    transformer_type: bool = False
    custom_model: bool = False ## ADDITIONAL PARAMETER
    LoRA_dim: int = 0 ## ADDITIONAL PARAMETER
...
def _build_vision_tower(
    ...
    if vision_cfg.timm_model_name:
        ...
        visual = VisionTransformer(
            ...
            custom=vision_cfg.custom_model,
            LoRA_dim=vision_cfg.LoRA_dim,
        )
