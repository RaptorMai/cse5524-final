...
**VPT-Deep**
    ...
    CUDA_VISIBLE_DEVICES=2 nohup python main.py --vpt_mode deep --vpt_num 10 > B14_DINOv2_VPT-DEEP_512.log 2>&1 &
...
**FacT-TK**  
    ...
    CUDA_VISIBLE_DEVICES=2 nohup python main.py  --optimizer adamw --fact_type tk --drop_path_rate 0.1 --debug --fact_dim 32 --fact_scaler 0.1 > logs/B14_DINOv2_FacT-TK_224.log 2>&1 &
